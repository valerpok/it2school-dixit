...
# dixit/config/settings.py - 2 = dixit/
ROOT_DIR = environ.Path(__file__) - 2
APPS_DIR = ROOT_DIR.path('dixit')
sys.path.append('dixit/apps')
...
MANAGERS = ADMINS
ADMIN_URL = 'admin/'
ADMIN_SITE_TITLE = 'dixit'
ADMIN_SITE_HEADER = 'dixit'
TIME_ZONE = 'UTC'
USE_TZ = True
LANGUAGE_CODE = 'en-us'
USE_I18N = True

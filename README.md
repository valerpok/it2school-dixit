...
```
After that you will see coverage report just below tests results. Also you can get access to HTML version of the report on [pages](https://dixit.git.steelkiwi.com/backend/)
...
``` 
Manually move `app_name` folder to `dixit/apps/`
```bash
$ mv app_name dixit/apps/
```
